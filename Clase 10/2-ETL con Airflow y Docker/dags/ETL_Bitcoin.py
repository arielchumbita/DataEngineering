...
url="data-engineer-cluster.cyhh5bfevlmn.us-east-1.redshift.amazonaws" #Ruta de la base de datos
with open(dag_path+'/keys/'+"db.txt",'r') as f: #Lee los archivos que están en la misma ruta del docker-compose
    data_base= f.read()
...
def extraer_data(exec_date):
    try:
         ...
         headers = {"Accept-Encoding": "gzip, deflate"} #Es importante: formatos que va a tomar desde la API
